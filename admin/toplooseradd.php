...
if(isset($_POST['submit'])){
      ...
      if(mysqli_num_rows($res)>0){
            ...
            $sqlPriority="Select * from top_looser";
            $resultPriority=mysqli_query($conn,$sqlPriority);
           
             $checknum=mysqli_num_rows($resultPriority);
             if($checknum<5){

      $sql="INSERT INTO `top_looser`(`symbol`, `ltp`, `change`) VALUES ('$symbol','$ltp','$change')";
...
<div id="main-head">
       <div class="part-two">
        ...
        <div id="headers">Add Top Looser</div>
        <a id="nextpage" href="toplooser.php">Click  Here To View Details</a>


        <form  action="toplooseradd.php" method="POST" id="forms">
       <div id="label1">
