...
$sql= "SELECT * FROM `top_gainer` $where";
...
<body>
<div class="part-two">
            <a class="subparttwo" href="#">  Top Gainer</a>
            </div>
            <div class="part-two">
      ...
      <form action="topgainer.php" method="POST">
...
<button class="btn" name="search"><i class="fas fa-search"></i></button>
    ...
    <h1>Top Five Gainer </h1><br>
  
   
    <a href="topgaineradd.php"><button class="btn-anchor">Click here to add details</button></a>
    <span id='date'>As on:
    <?php
...
?> 
    ...
    <td><a href="topgainerupdate.php?id=<?php echo $rows['id'];?>" onclick="clickupdate()"><i class="fas fa-edit"></i></a>
        <a href="deletetopgainer.php?id=<?php echo $rows['id'];?>" onclick="clickerror()"><i class="fas fa-trash-alt"></i></a>
    </td>
