...
include("database.php");
 ...
 $sno=$_GET['id'];
 $sql="Select * from top_turnover where id={$sno}";
...
<div id="main-head">
        ...
        <form onsubmit="return validation()" action="topturnoverupdating.php" method="POST">
       ...
       <div id="label2">
             ...
             <input type="text" id="ltp" name="total_turnover" value="<?php echo $row['total_turnover'];?>">
             <span id="ltperror"></span>
       </div>
       <div id="label3">
             <label>Ltp</label><br>
             <input type="text" id="change" name="ltp" value="<?php echo $row['ltp'];?>">
